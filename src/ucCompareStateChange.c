 ...
 * =============================================================================================
 * DESCRIPTION :
 * Implements ucCompareStateChange.
 * RELATED FILE  : src/ucCompareStateChange.c
 ...
 * =============================================================================================
 */
#include "ucCompareStateChange.h"
                                  ...
                                  uint8_t ucDelayReload)
{
  ...
  if ((pucSoftwareCommand != NULL) && (*pucSoftwareCommand == ON))
  {
    *pucSoftwareCommand = OFF;
    return 1U;
  }
