 ...
 * RELATED FILE  : src/project_specific/vProjectPrintSystemState.c
 ...
 * =============================================================================================
 */
#include "project_specific/vProjectPrintSystemState.h"
                                   ...
                                   uint32_t uiTimeoutMs)
{
  ...
  vUARTPrintString(xUart, cLine, uiTimeoutMs);
}
