 ...
 * RELATED FILE  : src/project_specific/m400_vProjectApplyAutomaticMode.c
 ...
 * =============================================================================================
 */
#include "project_specific/m400_vProjectApplyAutomaticMode.h"
...
static void ApplyTemperatureLow(uint8_t *pucStateTable,
                                float fTemperatureC,
                                uint8_t ucSetpoint,
                                const M400_ProjectControlledOutput_t *pxOutput);
                       ...
                       const M400_ProjectControlledOutput_t *pxOutput)
{
  ...
  if ((ucDayState == M400_ON) && (pxOutput->vTurnOff != NULL))
  {
    pxOutput->vTurnOff(pucStateTable);
  }
  else if ((ucNightState == M400_ON) && (pxOutput->vTurnOn != NULL))
  {
    pxOutput->vTurnOn(pucStateTable);
  }
}
