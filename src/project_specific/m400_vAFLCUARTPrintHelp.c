 ...
 * RELATED FILE  : src/project_specific/m400_vAFLCUARTPrintHelp.c
 ...
 * =============================================================================================
 */
#include "project_specific/m400_vAFLCUARTPrintHelp.h"
...
void M400_vAFLCUARTPrintHelp(UART_HandleTypeDef *xUart, uint32_t uiTimeoutMs)
{
  ...
  M400_vUARTPrintString(xUart, cHelp, uiTimeoutMs);
}
