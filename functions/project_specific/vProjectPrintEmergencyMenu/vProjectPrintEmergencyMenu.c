 ...
 * RELATED FILE  : src/project_specific/vProjectPrintEmergencyMenu.c
 ...
 * =============================================================================================
 */
#include "project_specific/vProjectPrintEmergencyMenu.h"
...
void vProjectPrintEmergencyMenu(UART_HandleTypeDef *xUart, uint32_t uiTimeoutMs)
{
  ...
  vUARTPrintString(xUart, cMenu, uiTimeoutMs);
}
